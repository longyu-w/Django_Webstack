# Generated by Django 4.1.7 on 2023-05-21 21:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='QWebStack.category')),
            ],
            options={
                'verbose_name': '子分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='QWebStack.subcategory')),
            ],
            options={
                'verbose_name': '站点',
